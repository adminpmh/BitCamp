...
--select sysdate, to_date('2020/0101','YYYY/MM/DD'),sysdate-to_date('2020/0101','YYYY/MM/DD') from dual;

21. 사원들의 상관 사번을 출력하되 상관이 없는 사원에 대해서는 NULL 값 대신 0으로 출력하시오.
select nvl(mgr,0) from emp; --nul(문자열,값) : null값
...
--select ename,sal,decode(job,'ANAlYST',sal+200,'SALESMAN',sal+180,'MANAGER',sal+150,'CLERK',sal+100) as upsal from emp; 
